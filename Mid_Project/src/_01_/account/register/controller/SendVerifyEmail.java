...
public class SendVerifyEmail {
	...
	private static final String EMAIL_SUBJECT = "測試用的帳號啟用信 (JAVA SMTP)";


	public void sendAccountVerify(String mailTo, String textUrl) {
		...
		try {
			...
			text.append("<p>這是測試用的帳號啟用信。</p>");
			text.append("<p>請點取下方連結啟用帳號</p>");
